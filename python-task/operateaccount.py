...
class TakeOperation :
    def __init__(self, root):
        ...
        self.b6 = Button(self.root, text="addBook",
                             width=40, height=2,
                             bg='light blue',
                             command=self.remove6)
        ...
        self.b5.place(x=150,y=550)
        self.b6.place(x=100,y=450)
